...
def AddRegionSizeToGroups(ClusteredList, ontologyDF, LabelImage):
...
def annotate_atlas(OntologyFilePath,AtlasMask,node_list_path):
    ...
    LabelImage = np.asarray(nib.load(AtlasMask).dataobj)
    ...
    path_atlas_groups = node_list_path.replace(".csv", "_AtlasGrouped.csv")
